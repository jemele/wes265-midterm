...
path=strcat('t:\xfer\xfer_res\jemele\projects\ucsd\wes265\assignments\midterm\1n')
...
grid on
axis([-2 2 -2 2])
title(['Constellation Diagram, Phase error + Matched Filter, \alpha=',num2str(alpha)])
