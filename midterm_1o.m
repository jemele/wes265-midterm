...
path=strcat('t:\xfer\xfer_res\jemele\projects\ucsd\wes265\assignments\midterm\1o')
...
frequency_offset = exp(j*2*pi*(0:length(x)-1)*0.00005)
h_s_n = h_s .* frequency_offset'
...
grid on
axis([-2 2 -2 2])
title(['Constellation Diagram, Frequency error + Matched Filter, \alpha=',num2str(alpha)])
